...
class Canvas extends Component {
    constructor(width, height, blockn, id, imageArray, indexArray) {
        super();
        this.id = id;
        this.blockn = blockn;
...
const Grid = () => {
    ...
    var imageArray = [];
    var loadNum = 0;
    var srcArray = ["assets/2.png", "assets/3.png", "assets/4.png"];
    var indexArray = [];
    for (let i = 0; i < 81; i++) {
        indexArray.push(i % 3)
    }
    for (let i = 0; i < imageNum; i++) {
        ...
        temp.src = srcArray[i];
        loadNum += 1;
        if (loadNum === imageNum) new Canvas(width, width, num, 'c1', imageArray, indexArray);
